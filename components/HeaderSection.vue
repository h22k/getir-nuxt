<template>
  <div class="bg-getir">
    <div class="max-w-screen-lg min-w-[1200px] mx-auto h-11 flex items-center justify-between">
      <nuxt-link to="/">
      ...
      <nav class="flex gap-x-8 text-sm font-semibold">
        <div class="flex items-center text-white/80 hover:text-white/100 transition-colors gap-x-2">
          <client-only>
            <v-icon name="globe" scale=".9"/>
          </client-only>
          <nuxt-link to="/">
            Türkçe (TR)
          </nuxt-link>
